                        ...
                        <ul class="shop__book-shoplist">
                            <li class="store">
                                <a href="${d}" target="_blank" rel="noopener noreferrer nofollow" aria-label="Amazon link">
                                    <img class="modal-shop-img shopping-shopimg amazon" src="${F}" alt="Amazon link" alt="Amazon live page"/>
                                </a>
                            </li>
                            <li class="store">
                                <a href="${d}" target="_blank" rel="noopener noreferrer nofollow" aria-label="BookShop link">
                                    <img class="modal-shop-img shopping-shopimg book-shop" src="${C}" alt="BookShop link" />
                                </a>
                            </li>
                        </ul>
                    </div>
